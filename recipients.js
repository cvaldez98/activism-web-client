...
function get_all(){
    let recv = [];
    for (let state of Object.keys(mailing_list)){
        for (let county of Object.keys(mailing_list[state])) {
            recv = recv.concat(mailing_list[state][county]);
        }
    }            
    return recv
}
...
function get_city(state, county){
...
function get_cities(state){
    let lst = ["Select All"]
    lst = lst.concat(Object.keys(mailing_list[state]));
    return lst
}

console.log(get_all());

module.exports = { get_all, get_state }